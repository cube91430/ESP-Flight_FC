...
float KalmanAngleRoll = 0, KalmanUncertaintyAgleRoll = 2*2;
float KalmanAnglePitch = 0, KalmanUncertaintyAglePitch = 2*2;
...
void loop() {
  ...
  Kalman_1d(KalmanAngleRoll, KalmanUncertaintAngleRoll, RateRoll, AngleRoll);
  KalmanAngleRoll = Kalman1DOutput[0];
  KalmanUncertaintyAngleRoll = Kalman1DOutput[1];
  Kalman_1d(KalmanAnglePitch, KalmanUncertaintAnglePitch, RatePitch, AnglePitch);
